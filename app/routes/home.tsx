      ...
      <div className="home">
        <Navbar />
          <section className="hero">
                    ...
                    <p>Introducing HomeArchi </p>

                    <h1>Build beautiful spaces at the speed of thought with HomeArchi</h1>
                    <p className="subtitle">
                        HomeArchi is an AI-first design environment that helps you visualize, render adn ship
                        architectural projects faster than ever.
                    </p>
                    <div className="actions">
                        <a href="#upload" className="cta">Start Building <ArrowRight className="icon" /></a>
                        <Button  className="demo" size="lg">Watch Demo</Button>
                    </div>
